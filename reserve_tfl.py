...
class ReserveTFL():
    ...
    def reserve(self):
        ...
        while not RESERVATION_FOUND:
            ...
            self.driver.get("https://www.exploretock.com/bluehillatstonebarns/experience/295232/blue-hill-at-stone-barns-private-dining/search?date=%s-%s-02&size=%s&time=%s" % (RESERVATION_YEAR, month_num(RESERVATION_MONTH), RESERVATION_SIZE, "19%3A00"))
    ...
    def login_tock(self):
        self.driver.get("https://www.exploretock.com/bluehillatstonebarns/experience/295232/blue-hill-at-stone-barns-private-dining/login")
